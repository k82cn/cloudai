...
from cloudai.systems import VolcanoSystem

from .volcano_job import VolcanoJob


class VolcanoRunner(BaseRunner):
    """
    ...
    def __init__(self, mode: str, system: System, test_scenario: TestScenario) -> None:
        ...
        self.volcano_system: VolcanoSystem = cast(VolcanoSystem, system)

    def _submit_test(self, test: Test) -> VolcanoJob:
        """
    ...
    def is_job_running(self, job: BaseJob) -> bool:
        ...
        if self.mode == "dry-run":
            return True
        return self.volcano_system.is_job_running(job.id)
